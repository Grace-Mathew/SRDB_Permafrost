...
permafrost_map <- terra::rast("raw_data/NCSCDv2_Circumpolar_raster_1deg/NCSCDv2_Circumpolar_WGS84_pfregion_extent_1deg.tif")
plot(permafrost_map)
```

```{r echo=FALSE}
permafrost_vals <- terra::extract(permafrost_map, coords)
